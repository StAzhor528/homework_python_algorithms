...
def check_1(lst_obj):
    ...
    """
    lst_to_set = set(lst_obj)  # O(n) - линейная, зависит от величины списка.
...
def check_2(lst_obj):
    ...
    Сложность: O(n) - линейная.
    """
    for j in range(len(lst_obj)):          # O(n) - линейная, зависит от величины списка.
...
def check_3(lst_obj):
    ...
    """
    lst_copy = list(lst_obj)                 # O(n) - линейная, зависит от длинны списка.
    lst_copy.sort()                          # O(n * log n) - линейно-логарифмическая.
    for i in range(len(lst_obj) - 1):        # O(n) - линейная, зависит от длинны списка
