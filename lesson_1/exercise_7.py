...
if __name__ == '__main__':
    def pal_checker(string):
        dc_obj = DequeClass()
        if ' ' in string: # Добавлена проверка на пробелы в сторке и их удаление при помощи join, split.
        ...
        while dc_obj.size() > 1 and still_equal:
            ...
            if first != last:
                still_equal = False
        return still_equal
    print(pal_checker('молоко дел или лед околом'))
    print(pal_checker('топот'))
    print(pal_checker('ошибка'))